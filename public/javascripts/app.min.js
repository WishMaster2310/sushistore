...
$(function(){function e(){$(this).scrollTop()>600&&!i?(i=!0,l.stop(!0).fadeIn(300)):$(this).scrollTop()<600&&i&&(i=!1,l.stop(!0).fadeOut(300))}function t(e){e.preventDefault(),$("html, body").stop(!0).animate({scrollTop:0},400)}$(".c-slider").slick({autoplay:!0,prevArrow:"<div class='c-slider__arrow c-slider__arrow--prev'>",nextArrow:"<div class='c-slider__arrow c-slider__arrow--next'>",responsive:[{breakpoint:769,settings:{arrows:!1,dots:!0}}]}),$(".c-appForm__input--tel").mask("+7 (999) 999-99-99"),$(".c-nav__item--list").on("click",function(e){"A"!==e.target.tagName&&(e.preventDefault(),$(this).hasClass("c-nav__item--active")?($($(this).find(".c-subNav")).css("display","block").stop(!0,!0).slideUp(300),$(this).removeClass("c-nav__item--active")):($($(this).find(".c-subNav")).stop(!0,!0).slideDown(300),$(this).addClass("c-nav__item--active")))}),$(".c-header__burger").on("click",function(){$(this).hasClass("c-header__burger--active")?($(this).removeClass("c-header__burger--active"),$(".c-navBox").slideUp()):($(this).addClass("c-header__burger--active"),$(".c-navBox").slideDown())}),$(".c-product-list .c-buyline__btn").on("click",function(){var e=$($(this).closest(".c-product").find(".c-product__img img")),t=$(".c-cart");if(e){var s=new Image;s.src=e.attr("src"),$(s).css({width:e.width(),position:"absolute",zIndex:3,top:e.offset().top,left:e.offset().left}),$("body").append(s),$(s).animate({top:t.offset().top,left:t.offset().left,width:"30px",opacity:0},600,function(){$(s).remove()})}});var s=0;$(".c-header__tel-handler").on("click",function(){var e=$(".c-header__tel").length;e>1&&(s<e-1?s+=1:s=0,$(".c-header__tel").removeClass("c-header__tel--active"),$(".c-header__tel").eq(s).addClass("c-header__tel--active"))}),$(window).on("resize",function(){$(".c-navBox").stop().attr("style",""),$(".c-header__burger").removeClass("c-header__burger--active")}),$(".j-fancy").on("click",function(e){e.preventDefault();var t=$(this).attr("data-fancy");t.length>0&&$.fancybox({content:$(t)})}),$("#headerCityChooser").SumoSelect(),$(".c-buyline__arr--top").on("click",function(){var e=$(this).closest(".c-buyline").find(".c-buyline__input");$(e).val(+$(e).val()+1)}),$(".c-buyline__arr--down").on("click",function(){var e=$(this).closest(".c-buyline").find(".c-buyline__input");$(e).val()>1&&$(e).val(+$(e).val()-1)}),$(".c-banner__slider").slick({dots:!0,arrows:!1}),$("#form-tel").mask("+7 (999) 999-99-99"),$(".c-btn__scroll-to").on("click",function(e){var t=$(this).attr("href");e.preventDefault(),$("html, body").animate({scrollTop:$(t).offset().top},1e3)});var i=!1,l=$(".c-scrolltop");l.length>0&&($(document).on("scroll",e),$(l).on("click",t)),$(".c-sellpoint__aside-scroll").length>0&&$(".c-sellpoint__aside-scroll").jScrollPane({verticalGutter:0,verticalDragMaxHeight:200});var c=$(".c-sellpoint__thumbs-slider"),o=$(".c-sellpoint__slider-inner");o.slick({infinite:!1,dots:!0,prevArrow:"<div class='c-sellpoint__slider-arrow c-sellpoint__slider-arrow--prev'><span></span><div>",nextArrow:"<div class='c-sellpoint__slider-arrow c-sellpoint__slider-arrow--next'><span></span><div>",responsive:[{breakpoint:758,settings:{arrows:!1}}]}),o.on("afterChange",function(e,t,s){console.log("current: ",s),$(".c-sellpoint__thumbs-slide").eq(s).addClass("is-active").siblings(".c-sellpoint__thumbs-slide").removeClass("is-active")}),c.slick({infinite:!1,arrows:!1,dots:!0,slidesToShow:4,slidesToScroll:4,asNavFor:o}),$(".c-sellpoint__thumbs-slide").on("click",function(){o.slick("goTo",$(this).index())}),$(".c-sellpoint__thumbs-slide").eq(0).addClass("is-active")});
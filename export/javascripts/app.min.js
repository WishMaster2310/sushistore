...
$(function(){$(".c-slider").slick({autoplay:!0,prevArrow:"<div class='c-slider__arrow c-slider__arrow--prev'>",nextArrow:"<div class='c-slider__arrow c-slider__arrow--next'>",responsive:[{breakpoint:769,settings:{arrows:!1,dots:!0}}]}),$(".c-appForm__input--tel").mask("+7 (999) 999-99-99"),$(".c-nav__item--list").on("click",function(e){"A"!==e.target.tagName&&(e.preventDefault(),$(this).toggleClass("c-nav__item--active"),$($(this).find(".c-subNav")).stop(!0,!0).slideToggle())}),$(".c-header__burger").on("click",function(){$(this).hasClass("c-header__burger--active")?($(this).removeClass("c-header__burger--active"),$(".c-navBox").slideUp()):($(this).addClass("c-header__burger--active"),$(".c-navBox").slideDown())}),$(window).on("resize",function(){$(".c-navBox").stop().attr("style",""),$(".c-header__burger").removeClass("c-header__burger--active")})});
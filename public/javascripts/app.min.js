...
$(function(){$(".c-slider").slick({arrows:!1,autoplay:!0}),$(".c-appForm__input--tel").mask("+7 (999) 999-99-99"),$(".c-nav__item--list").on("click",function(t){t.preventDefault(),"A"!==t.target.tagName&&$($(this).find(".c-subNav")).stop(!0,!0).slideToggle()})});